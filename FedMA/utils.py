...
def load_mnist_data(datadir):
    ...
    X_train = X_train.data.numpy()[0:2000]
    y_train = y_train.data.numpy()[0:2000]
    X_test = X_test.data.numpy()[0:500]
    y_test = y_test.data.numpy()[0:500]
...
def load_cifar10_data(datadir):
    ...
    X_train, y_train = cifar10_train_ds.data[0:2000], cifar10_train_ds.target[0:2000]
    X_test, y_test = cifar10_test_ds.data[0:500], cifar10_test_ds.target[0:500]
...
def get_dataloader(dataset, datadir, train_bs, test_bs, dataidxs=None):
    ...
    if dataset in ('mnist', 'cifar10'):
        ...
        train_ds.data.data = train_ds.data.data[0:2000]
        train_ds.target.data = train_ds.target.data[0:2000]
        test_ds.data.data = test_ds.data.data[0:500]
        test_ds.target.data = test_ds.target.data[0:500]
